...
class Ion_auth
{
	...
	public function logout()
	{
		...
		$identity = $this->ci->config->item('session_identifier', 'ion_auth')."_identifier";
		$userName = $this->ci->config->item('session_identifier', 'ion_auth')."_userName";
		$userId = $this->ci->config->item('session_identifier', 'ion_auth')."_userName";
	...
	public function check_access()
	{
		if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH']=="XMLHttpRequest") {
           ...
           $username = $this->ci->session->userdata($this->ci->config->item('email_type', 'ion_auth').'_userName');
