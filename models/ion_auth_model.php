              ...
              /*  if ($user->active == 0)
			   ...
			   $code = null;
                ...
                $session_data = array(
                    ...
                    $this->config->item("session_identifier", "ion_auth").'_identifier' => $user->{$this->identity_column},
                    $this->config->item("session_identifier", "ion_auth").'_userName'             => $user->username,
    				...
    				'code'=>$code,
               //     'email'                => $user->email,
                    $this->config->item("session_identifier", "ion_auth").'_userId'              => $user->id 
