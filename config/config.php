...
if($_SERVER['SERVER_NAME'] == 'www.lithefire.net'){
	$config['base_url']	= 'http://'.$_SERVER['SERVER_NAME'].'/dev/ils/';
...
|
*/
$config['encryption_key'] = 'ils@qwert.com.ph';
...
|
*/
$config['sess_cookie_name']		= 'ilscookie';
...
$config['sysname'] = 'ILS';
$config['app_name'] = "Online Library";
$config['fr_db'] = 'lithefzj_engine';
$config['default_db'] = 'lithefzj_library';
$config['ils_db'] = 'lithefzj_library';
$config['ogs_db'] = 'lithefzj_ogs';
$config['swp_db'] = 'lithefzj_swp';
